...
namespace RVO
{
    ...
    public struct RVOMath
    {
         ...
         */
        public static float abs(in Vector2 vector)
        {
         ...
         */
        public static float absSq(in Vector2 vector)
        {
         ...
         * matrix.</param>
         */
        internal static float det(in Vector2 vector1, in Vector2 vector2)
        {
         ...
         * be calculated.</param>
         */
        internal static float distSqPointLineSegment(in Vector2 vector1, in Vector2 vector2, in Vector2 vector3)
        {
         ...
         * calculated.</param>
         */
        internal static float leftOf(in Vector2 a, in Vector2 b, in Vector2 c)
        {
            return det(a - c, b - a);
        }
