...
namespace RVO
{
    ...
    internal class KdTree
    {
        ...
        internal void buildObstacleTree()
        {
            ...
            IList<Obstacle> obstacles = new List<Obstacle>(Simulator.Instance.obstacles_);
        ...
        private void buildAgentTreeRecursive(int begin, int end, int node)
        {
            ...
            if (end - begin > MAX_LEAF_SIZE)
            {
                ...
                var t1 = new System.Threading.Tasks.Task(() => buildAgentTreeRecursive(begin, left, agentTree_[node].left_));
                var t2 = new System.Threading.Tasks.Task(() => buildAgentTreeRecursive(left, end, agentTree_[node].right_));
                t1.Start();
                t2.Start();
        ...
        private void queryAgentTreeRecursive(in Vector2 position, ref float rangeSq, ref int agentNo, int node)
        {
