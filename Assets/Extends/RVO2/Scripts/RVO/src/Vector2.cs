...
namespace RVO
{
    ...
    public struct Vector2
    {
         ...
         */
        public static float operator *(in Vector2 vector1, in Vector2 vector2)
        {
         ...
         */
        public static Vector2 operator *(in float scalar, in Vector2 vector)
        {
         ...
         * <param name="scalar">The scalar value.</param>
         */
        public static Vector2 operator *(in Vector2 vector, in float scalar)
        {
         ...
         * <param name="vector2">The second two-dimensional vector.</param>
         */
        public static Vector2 operator +(in Vector2 vector1, in Vector2 vector2)
        {
